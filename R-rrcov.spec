...
Version  : 1.7.7
Release  : 68
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/rrcov_1.7-7.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/rrcov_1.7-7.tar.gz
...
%setup -q -n rrcov
pushd ..
cp -a rrcov buildavx2
popd
pushd ..
cp -a rrcov buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745332265
...
/usr/lib64/R/library/rrcov/data/Cars.rda
...
/usr/lib64/R/library/rrcov/data/ionosphere.rda
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/rrcov/libs/rrcov.so
/V4/usr/lib64/R/library/rrcov/libs/rrcov.so
